...
const STEPS: { n: string; icon: LucideIcon; title: string; desc: string; time: string; color: string }[] = [
  { n: "01", icon: MessageCircle,title: "Just start typing", desc: "No signup wall. Try KYROO for a few messages right on the homepage, see how she actually talks first.", time: "0 min", color: "var(--k-lime)" },
  { n: "02", icon: PenLine,      title: "Sign up when you're in", desc: "10 quick questions once you're ready to keep going. Tell KYROO your goals, lifestyle, habits, and how you like to be spoken to.", time: "~2 min", color: "var(--k-coral)" },
  ...
  return (
    <div className="k-grain" style={{ background: "var(--k-paper)", minHeight: "100vh", color: "var(--k-ink)", fontFamily: "var(--font-body)", overflowX: "hidden" }}>
      ...
      <nav className="k-fade-1 k-nav" style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 40px", background: scrolled ? "var(--k-paper)" : "transparent", borderBottom: scrolled ? "3px solid var(--k-ink)" : "3px solid transparent", transition: "all .25s ease" }}>
        <a href="/" style={{ display: "flex", alignItems: "center", gap: 9, textDecoration: "none", color: "var(--k-ink)" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <button className="k-btn k-btn-ghost" onClick={go("/")} style={{ padding: "9px 16px", fontSize: 13, boxShadow: "4px 4px 0 var(--k-ink)" }}>Log in</button>
          <button className="k-btn k-btn-coral" onClick={go("/")} style={{ padding: "9px 20px", fontSize: 13, boxShadow: "4px 4px 0 var(--k-ink)" }}>Start chatting →</button>
        </div>
      </nav>
      ...
      <section style={{ position: "relative", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "150px 24px 80px", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap", position: "relative", zIndex: 2 }} className="k-fade-4">
          <button className="k-btn k-btn-lime" onClick={go("/")} style={{ padding: "18px 40px", fontSize: 16, display: "inline-flex", alignItems: "center", gap: 10 }}>
            <MessageCircle size={19} strokeWidth={2.4} />Start chatting, it's free →
          </button>
      ...
      <section id="how" ref={howRef.ref} className="pad" style={{ padding: "110px 48px", background: "var(--k-paper-2)", borderTop: "3px solid var(--k-ink)", borderBottom: "3px solid var(--k-ink)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 60, opacity: howRef.inView ? 1 : 0, transform: howRef.inView ? "translateY(0)" : "translateY(20px)", transition: "all .5s ease" }}>
            ...
            <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(32px,5vw,58px)", letterSpacing: -1.5, marginTop: 18, textTransform: "uppercase" }}>
              No signup wall. <span style={{ color: "var(--k-coral)" }}>Just talk.</span>
            </h2>
          </div>
          ...
          <div style={{ textAlign: "center", marginTop: 52 }}>
            <button className="k-btn k-btn-coral" onClick={go("/")} style={{ padding: "16px 38px", fontSize: 15, display: "inline-flex", alignItems: "center", gap: 10 }}>
              <MessageCircle size={17} strokeWidth={2.4} /> Try KYROO now, it's free
            </button>
          </div>
        </div>
      </section>
      ...
      <section className="pad" style={{ padding: "120px 48px", textAlign: "center", background: "var(--k-ink)", position: "relative", overflow: "hidden" }}>
        <div style={{ maxWidth: 700, margin: "0 auto", position: "relative", zIndex: 2 }}>
          ...
          <p style={{ fontFamily: "var(--font-mono-tag)", fontSize: 13, color: "var(--k-paper)", opacity: 0.6, lineHeight: 1.8, margin: "36px auto 40px", maxWidth: 400 }}>
            NO SIGNUP WALL. SHOWS UP EVERY MORNING. REMEMBERS EVERYTHING. GETS BETTER EVERY DAY.
          </p>
          <button className="k-btn k-btn-lime" onClick={go("/")} style={{ padding: "19px 46px", fontSize: 16, display: "inline-flex", alignItems: "center", gap: 12 }}>
            <MessageCircle size={19} strokeWidth={2.4} /> Start chatting for free
          </button>
                ...
                <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: 11, padding: 0 }}>
                  {s.links.map((l) => {
                    const hrefs: Record<string, string> = {
                      ...
                      "Pricing": "/about#pricing", "Features": "/about#features", "How it works": "/about#how",
